  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fff' }}>
      <form onSubmit={handleSubmit} style={{ background: 'white', padding: '20px', borderRadius: '8px', boxShadow: '0 0 10px rgba(0,0,0,0.1)', width: '100%', maxWidth: '400px' }}>
        ...
        {/* Uniform name field */}
        <input name="name" onChange={handleChange} placeholder={`${type} Name`} style={inputStyle} required />
        ...
        {type === 'donor' && (
          <>
            <input name="blood_type" onChange={handleChange} placeholder="Blood Type" style={inputStyle} />
          </>
        )}

        <input name="contact_number" onChange={handleChange} placeholder="Contact Number" style={inputStyle} />
        <input name="address" onChange={handleChange} placeholder="Address" style={inputStyle} />
